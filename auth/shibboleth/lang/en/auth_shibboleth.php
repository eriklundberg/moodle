...
$string['auth_shib_noaccounturl'] = 'No account information URL';
$string['auth_shib_noaccounturl_description'] = 'Provide the URL that Shibboleth users will be directed to if they are successfully authorized but does not have an account on this Moodle instance. This option is only relevant if Shibboleth is not allowed to automatically create new accounts.';
